...
def find_images():
    ...
    The folder name is used as the
    ground-truth ripeness category.
    """
...
def analyse_one_image(
    ...
    banana segmentation and GLCM
    feature extraction used by the
    validation dataset.
    """
...
def print_statistics(
    ...
    print()
    print("=" * 75)
    print("GLCM TEST DATASET STATISTICS")
    print("=" * 75)
...
def main():
    ...
    print(
        "Starting GLCM test feature extraction..."
    )
    ...
    print("=" * 75)
    print("TEST FEATURE EXTRACTION FINISHED")
    print("=" * 75)
